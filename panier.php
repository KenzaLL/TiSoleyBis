...
<html lang="fr">
    <head>
        ...
        <title> Pizzeria Ti'Soley -panier </title>
    </head>
    ...
    <body>
        <nav class="navbar navbar-expand-lg nav-b">
            ...
            <ul class="dropdown-menu bg-black">
                ...
                <li>
                    <a class="dropdown-item text-white" href="./terrede ssences.php"> Terre d'essences</a>
                </li>
                </ul>
                </li>
                <li class="nav-item dropdown">
    ...
    <footer>
        <div class="reseaux mt-5">
            ...
            <p> 
                <img src="./images/maps.png" alt="" width="40px"> 
